...
System.out.println("\n ========FÁBRICA FELIZ=======\n");
System.out.println("Digite seu número de operário:");
NumeroOp = sc.nextInt();

System.out.println("Digite a quantidade de peças feitas por mês:");
...
if (PeçaMensal<=30){
	...
	Salario = 150 + (0.03 * Salario) * (PeçaMensal - 30);
}
else if (PeçaMensal > 35){
Salario = 150 + (0.05 * Salario) * (PeçaMensal - 30);
}
